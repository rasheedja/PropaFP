...
(assert
  (and
    (real_square_root__function_guard
      ...
      (fp.to_real x))
    (= (bool_le1
         (ite (>= (+ (real_square_root (fp.to_real x)) (- (fp.to_real 
         y))) 0.0) (+ (real_square_root (fp.to_real x)) (- (fp.to_real 
         y))) (- (+ (real_square_root (fp.to_real x)) (- (fp.to_real 
         y)))))
...
(assert
  (and
    (=>
      (and (and (or (< 1 i) (= 1 i)) (or (< i n) (= i n))) (fp.isFinite32 y))
      (=>
        (not (and (or (< 1 i) (= 1 i)) (or (< i n) (= i n))))
        (= false true)))
    (=>
      (not
        (and
          ...
          (fp.isFinite32 y)))
      (and
        (=> (and (or (< 1 i) (= 1 i)) (or (< i n) (= i n))) (= false true))
        (=>
          (not (and (or (< 1 i) (= 1 i)) (or (< i n) (= i n))))
          (= false true))))))
...
(assert
  ...
  (=>
    (real_square_root__function_guard
      ...
      (fp.to_real x))
    (= (bool_le1
         (ite (>= (+ (real_square_root (fp.to_real x)) (- (fp.to_real (fp.div RNE (fp.add RNE 
         y (fp.div RNE x y)) (fp #b0 #b10000000 #b00000000000000000000000))))) 0.0) (+ 
         (real_square_root
           (fp.to_real x)) (- (fp.to_real (fp.div RNE (fp.add RNE y (fp.div RNE 
         x y)) (fp #b0 #b10000000 #b00000000000000000000000))))) (- (+ 
         (real_square_root
           (fp.to_real x)) (- (fp.to_real (fp.div RNE (fp.add RNE y (fp.div RNE 
         x y)) (fp #b0 #b10000000 #b00000000000000000000000)))))))
         (+ (* (to_real1 1) (/ 1.0 (to_real1 (power 2 (power 2 (+ i 1)))))) (* 
         (to_real1
