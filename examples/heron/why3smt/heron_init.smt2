...
;; defqtvc
 ;; File "certified_heron.ads", line 7, characters 0-0
  ...
  (= (ite (or
          (< (ite (or
                  (< 0.0 (+ (sqrt1 (fp.to_real x)) (- (fp.to_real (fp.div RNE (fp.add RNE (fp #b0 #b01111111 #b00000000000000000000000) (fp.div RNE 
                  x (fp #b0 #b01111111 #b00000000000000000000000))) (fp #b0 #b10000000 #b00000000000000000000000))))))
                  (= 0.0 (+ (sqrt1 (fp.to_real x)) (- (fp.to_real (fp.div RNE (fp.add RNE (fp #b0 #b01111111 #b00000000000000000000000) (fp.div RNE 
                  x (fp #b0 #b01111111 #b00000000000000000000000))) (fp #b0 #b10000000 #b00000000000000000000000)))))))
             (+ (sqrt1 (fp.to_real x)) (- (fp.to_real (fp.div RNE (fp.add RNE (fp #b0 #b01111111 #b00000000000000000000000) (fp.div RNE 
             x (fp #b0 #b01111111 #b00000000000000000000000))) (fp #b0 #b10000000 #b00000000000000000000000)))))
             (- (+ (sqrt1 (fp.to_real x)) (- (fp.to_real (fp.div RNE (fp.add RNE (fp #b0 #b01111111 #b00000000000000000000000) (fp.div RNE 
             x (fp #b0 #b01111111 #b00000000000000000000000))) (fp #b0 #b10000000 #b00000000000000000000000))))))) (+ (* (to_real 1) (/ 1.0 
          (pow (to_real 2) (pow (to_real 2) (to_real 1))))) (* (to_real (* 3 1)) (* (to_real 1) (/ 1.0 (to_real 8388608))))))
          (= (ite (or
                  (< 0.0 (+ (sqrt1 (fp.to_real x)) (- (fp.to_real (fp.div RNE (fp.add RNE (fp #b0 #b01111111 #b00000000000000000000000) (fp.div RNE 
                  x (fp #b0 #b01111111 #b00000000000000000000000))) (fp #b0 #b10000000 #b00000000000000000000000))))))
                  (= 0.0 (+ (sqrt1 (fp.to_real x)) (- (fp.to_real (fp.div RNE (fp.add RNE (fp #b0 #b01111111 #b00000000000000000000000) (fp.div RNE 
