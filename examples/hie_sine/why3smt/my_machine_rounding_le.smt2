...
;; Assume
  ...
  (and (or (< (- 2147483648) y) (= (- 2147483648) y))
...
;; Ensures
  (assert
  (and
  (or (< (- 2147483648) (to_int1 RNA x)) (= (- 2147483648) (to_int1 RNA x)))
  (or (< (to_int1 RNA x) 2147483647) (= (to_int1 RNA x) 2147483647))))

(assert
;; defqtvc
 ;; File "certified_sine.ads", line 23, characters 0-0
  (not
  (= (ite (or
          (< (+ (fp.to_real x) (- (to_real (to_int1 RNA x)))) (* (to_real 500000001) (/ 1.0 (to_real 1000000000))))
          (= (+ (fp.to_real x) (- (to_real (to_int1 RNA x)))) (* (to_real 500000001) (/ 1.0 (to_real 1000000000)))))
     true false) true)))
(check-sat)
