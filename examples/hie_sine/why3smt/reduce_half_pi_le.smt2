...
;; Ensures
  ...
  (of_int RNE r1) c1)) (fp.mul RNE (of_int RNE r1) c2)) (fp.mul RNE (of_int
                                                                    RNE 
                                                                    r1) 
...
;; defqtvc
 ;; File "certified_sine.ads", line 36, characters 0-0
  (not
  (= (ite (or
          (< (+ (fp.to_real (fp.sub RNE (fp.sub RNE (fp.sub RNE (fp.sub RNE 
          x (fp.mul RNE (of_int RNE r1) c1)) (fp.mul RNE (of_int RNE r1) 
          c2)) (fp.mul RNE (of_int RNE r1) c3)) (fp.mul RNE (of_int RNE r1) 
          c4))) (- (+ (fp.to_real x) (- (* (* (to_real r1) pi1) (/ 1.0 (fp.to_real (fp #b0 #b10000000 #b00000000000000000000000)))))))) (* (to_real 18) (/ 1.0 (to_real 100000))))
          (= (+ (fp.to_real (fp.sub RNE (fp.sub RNE (fp.sub RNE (fp.sub RNE 
          x (fp.mul RNE (of_int RNE r1) c1)) (fp.mul RNE (of_int RNE r1) 
          c2)) (fp.mul RNE (of_int RNE r1) c3)) (fp.mul RNE (of_int RNE r1) 
          c4))) (- (+ (fp.to_real x) (- (* (* (to_real r1) pi1) (/ 1.0 (fp.to_real (fp #b0 #b10000000 #b00000000000000000000000)))))))) (* (to_real 18) (/ 1.0 (to_real 100000)))))
