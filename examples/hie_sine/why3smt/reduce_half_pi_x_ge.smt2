...
;; defqtvc
 ;; File "certified_sine.ads", line 36, characters 0-0
  (not
  (fp.leq (fp.neg (fp #b0 #b01111110 #b10100010001101010111010)) (fp.sub RNE (fp.sub RNE (fp.sub RNE (fp.sub RNE 
  x (fp.mul RNE (of_int RNE r1) c1)) (fp.mul RNE (of_int RNE r1) c2)) (fp.mul RNE 
  (of_int RNE r1) c3)) (fp.mul RNE (of_int RNE r1) c4)))))
(check-sat)
