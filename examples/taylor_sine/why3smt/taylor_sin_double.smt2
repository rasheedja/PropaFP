...
;; user_eq
(declare-fun user_eq (long_float
  long_float) Bool)
...
(assert
  (and
    (fp.leq (fp.neg (fp #b0 #b01111111110 #b0000000000000000000000000000000000000000000000000000)) 
    x)
    (fp.leq x (fp #b0 #b01111111110 #b0000000000000000000000000000000000000000000000000000))))

;; Ensures
(assert (fp.isFinite64 (fp.mul RNE x x)))

;; Ensures
(assert (fp.isFinite64 (fp.mul RNE (fp.mul RNE x x) x)))

;; Ensures
(assert
  (fp.isFinite64 (fp.sub RNE x (fp.div RNE (fp.mul RNE (fp.mul RNE x 
  x) x) (fp #b0 #b10000000001 #b1000000000000000000000000000000000000000000000000000)))))

;; Goal def'vc
;; File "taylor_sin.ads", line 15, characters 0-0
(assert
  (not
  (=>
    ...
    (= (bool_le1
         ...
         x (fp.div RNE (fp.mul RNE (fp.mul RNE x x) x) (fp #b0 #b10000000001 #b1000000000000000000000000000000000000000000000000000)))))) 0.0) (+ 
         (real_sin
           (fp.to_real x)) (- (fp.to_real (fp.sub RNE x (fp.div RNE (fp.mul RNE (fp.mul RNE 
         x x) x) (fp #b0 #b10000000001 #b1000000000000000000000000000000000000000000000000000)))))) (- (+ 
         (real_sin
           (fp.to_real x)) (- (fp.to_real (fp.sub RNE x (fp.div RNE (fp.mul RNE (fp.mul RNE 
         x x) x) (fp #b0 #b10000000001 #b1000000000000000000000000000000000000000000000000000))))))))
         (* (to_real1 258872) (/ 1.0 (to_real1 1000000000)))) true))))
