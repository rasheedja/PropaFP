...
(declare-fun rem1 (Float64 Float64) Float64)
...
(assert
;; defqtvc
 ;; File "quadratic_equations.ads", line 18, characters 0-0
  (not
  (= (ite (or
          (< (ite (or
                  (< 0.0 (+ (sin1 (fp.to_real x)) (- (fp.to_real (fp.sub RNE 
                  x (fp.div RNE (fp.mul RNE (fp.mul RNE x x) x) (fp #b0 #b10000000001 #b1000000000000000000000000000000000000000000000000000)))))))
                  (= 0.0 (+ (sin1 (fp.to_real x)) (- (fp.to_real (fp.sub RNE 
                  x (fp.div RNE (fp.mul RNE (fp.mul RNE x x) x) (fp #b0 #b10000000001 #b1000000000000000000000000000000000000000000000000000))))))))
             (+ (sin1 (fp.to_real x)) (- (fp.to_real (fp.sub RNE x (fp.div RNE (fp.mul RNE (fp.mul RNE 
             x x) x) (fp #b0 #b10000000001 #b1000000000000000000000000000000000000000000000000000))))))
             (- (+ (sin1 (fp.to_real x)) (- (fp.to_real (fp.sub RNE x (fp.div RNE (fp.mul RNE (fp.mul RNE 
             x x) x) (fp #b0 #b10000000001 #b1000000000000000000000000000000000000000000000000000)))))))) (* (to_real 258872) (/ 1.0 (to_real 1000000000))))
          (= (ite (or
                  (< 0.0 (+ (sin1 (fp.to_real x)) (- (fp.to_real (fp.sub RNE 
                  x (fp.div RNE (fp.mul RNE (fp.mul RNE x x) x) (fp #b0 #b10000000001 #b1000000000000000000000000000000000000000000000000000)))))))
                  (= 0.0 (+ (sin1 (fp.to_real x)) (- (fp.to_real (fp.sub RNE 
