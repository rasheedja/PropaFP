...
;; Goal def'vc
;; File "taylor_sin.ads", line 32, characters 0-0
(assert
  (not
  (=>
    (real_sin__function_guard (real_sin (fp.to_real x)) (fp.to_real x))
    (= (bool_le1
         (ite (>= (+ (real_sin (fp.to_real x)) (- (fp.to_real (fp.add RNE 
         x (fp.div RNE (fp.mul RNE (fp.mul RNE x x) x) (fp #b0 #b10000001 #b10000000000000000000000)))))) 0.0) (+ 
         (real_sin
           (fp.to_real x)) (- (fp.to_real (fp.add RNE x (fp.div RNE (fp.mul RNE (fp.mul RNE 
